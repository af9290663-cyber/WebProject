...
// FIX: moved PHP logic to the TOP before any HTML output
// Previously config.php was included TWICE and session_start() was after HTML output
if (isset($_POST['send'])) {
...
<head>
    ...
    <!-- FIX: removed duplicate stylesheet link (was included twice) -->
    <link rel="stylesheet" href="stayle.css">
    <title>Create Account</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<!-- FIX: added bg-gradient class so body styling works with Tailwind -->
...
<div class="bg-white p-8 rounded-2xl shadow-2xl w-80">
    ...
    <!-- FIX: added novalidate to allow custom error messages above -->
    <form action="createcc.php" method="post" class="space-y-4">
        ...
        <div class="text-center mt-3">
            <a href="login.php" class="text-purple-500 hover:underline">Already have an account? Login</a>
        </div>
